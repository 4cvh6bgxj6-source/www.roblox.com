!(function () {
  ...
  var a = {
    ...
    s = "@",
    e =
      (e.EnvironmentUrls.universalAppConfigurationApi,
      {
    ...
    o = (0, n.withTranslations)(function (e) {
      var t = e.userId,
        n = e.username,
        a = e.displayName,
        c = e.onAccountSelection,
        o = e.disabled,
        e = e.translate;
      return h().createElement(
        "li",
        ...
        h().createElement(
          ...
          h().createElement(
            ...
            h().createElement(l.Thumbnail2d, {
              containerClass: "avatar-card-image",
              type: l.ThumbnailTypes.avatarHeadshot,
              targetId: t,
              size: l.ThumbnailAvatarHeadshotSize.size48,
            })
          ),
          h().createElement(
            "div",
    ...
    i = (0, n.withTranslations)(function (e) {
      function t() {
        o(), u(!1);
      }
      var n = e.users,
        a = e.invalidUsers,
        c = e.onAccountSelection,
        o = e.onAccountSelectorAbandoned,
        l = e.titleText,
        s = e.helpText,
        r = e.translate,
        i = (0, d.useState)(!0),
      ...
      return h().createElement(
        p.Modal,
        { className: "account-selector-modal", show: e, onHide: t, size: "lg" },
        h().createElement(
          d.Fragment,
          null,
          h().createElement(p.Modal.Header, {
              ...
              0 < a.length &&
                h().createElement(
                  ...
                  h().createElement(
                    "p",
                    { className: "account-selector-help-text" },
                    r(E.ResponseChooseAnotherMethod)
                  ),
                  h().createElement(m, {
                    users: a,
                    ...
                    p.Button,
                    {
                      ...
                      onClick: function () {
                        window.dispatchEvent(
                          new Event("closeEmailVerifyCodeModal")
                        ),
                          t();
                      },
                    },
                    r(E.LabelBackToLogin)
                  )
                )
            )
          )
    ...
    e = {
      renderAccountSelectorModal: (e = function (e) {
        var t = e.containerId,
          n = e.users,
          a = e.invalidUsers,
          c = e.onAccountSelection,
        ...
        return (
          null != t &&
          ((0, r.unmountComponentAtNode)(t),
          (0, r.render)(
            h().createElement(i, {
              users: n,
              invalidUsers: a,
              onAccountSelection: c,
              onAccountSelectorAbandoned: o,
              titleText: l,
              helpText: s,
              translate: e,
            }),
  ...
  Object.assign(t(), { AccountSelectorService: e });
})();
