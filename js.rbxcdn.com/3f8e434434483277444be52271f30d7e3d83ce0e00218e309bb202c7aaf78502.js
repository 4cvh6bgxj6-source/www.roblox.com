  ...
  var a = {
      ...
      104: function (e, t, a) {
        ...
        var n = a(577),
          ...
          n = {
            urls: {
              getMetadata:
                n.EnvironmentUrls.apiGatewayCdnUrl + "/captcha/v1/metadata",
              funCaptchaRedeem: {
                WebSignup:
                  n.EnvironmentUrls.captchaApi + "/v1/funcaptcha/signup/web",
                AppSignup:
                  n.EnvironmentUrls.captchaApi + "/v1/funcaptcha/signup/app",
                WebLogin:
                  n.EnvironmentUrls.captchaApi + "/v1/funcaptcha/login/web",
                AppLogin:
                  n.EnvironmentUrls.captchaApi + "/v1/funcaptcha/login/app",
                WebResetPassword:
                  n.EnvironmentUrls.captchaApi +
                  "/v1/funcaptcha/resetpassword/web",
                UserAction:
                  n.EnvironmentUrls.captchaApi + "/v1/funcaptcha/user",
          ...
          return (
            a.getMetadata().then(
              function (e) {
                ...
                r.debug("Add captcha types from new webapp:", n),
            ...
            (a = [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return t
                    ? (delete this.timeStore[e], new Date().valueOf() - t)
                    : null;
                },
              },
            ]) && i(e.prototype, a),
      ...
      434: function (e, t, a) {
        ...
        var n = a(577),
          ...
          i = a.n(t),
          n =
            null !== (n = n.EnvironmentUrls.apiGatewayUrl) && void 0 !== n
              ? n
              : "URL_NOT_FOUND",
      ...
      934: function (e, t, a) {
          ...
          y =
            ((n = r =
              !(i = {
                    ...
                    n ||
                      ...
                      null !==
                        (e = document.getElementById(
                          w.A.eventElementIds.shown
                        )) &&
                        ((e.value = w.A.hybridEvents.shown),
                        e.dispatchEvent(o)),
                      (n = !0));
                  }
                },
                successCb: function (e, t) {
                  ...
                  null != e &&
                    (null !== a && (e.value = JSON.stringify(a)),
                    e.dispatchEvent(o));
                },
                errorCb: S,
            ...
            ),
            {
              triggerCaptcha: function () {
                ...
                C.A
                  ? (T.UrlParser &&
                      ((e = T.UrlParser.getParameterValueByName(
                        "credentialstype",
                        !1
                      )),
                      (t = T.UrlParser.getParameterValueByName(
                        "credentialsvalue",
                        !1
                      )),
                      null !== e &&
                      ...
                      (i.returnTokenInSuccessCb =
                        "1" ===
                        T.UrlParser.getParameterValueByName(
                          "hybrid-return-token",
                          !1
                        )),
                      null !==
        ...
        function x(e) {
          ...
          u &&
            ...
            (t = (function (e) {
              for (
                var t = g.captchaSolvedPrefix,
                  a = g.captchaSolveTimeIntervals,
                  n = 0;
                n < a.length;
                n++
              ) {
        ...
        function O(e, t, a) {
          ...
          E().ajax({
            ...
            success: function () {
              window.EventTracker &&
                window.EventTracker.fireEvent(A(e + g.successSuffix)),
                I(e, a, !0),
                l && (l(), E()("#" + s).empty());
            },
            error: function () {
              window.EventTracker &&
                window.EventTracker.fireEvent(A(e + g.failSuffix)),
                I(e, a, !1),
                f && f(),
                T.BootstrapWidgets &&
              ...
              reset: function (e, t, a, n) {
                (d = e),
                  ...
                  window.grecaptcha &&
                    ...
                    m.invisible && window.grecaptcha.execute(p));
              },
              render: function (e, t, a, n, i) {
                (d = t),
                  ...
                  window.grecaptcha &&
                    ...
                    window.EventTracker &&
                      window.EventTracker.fireEvent(A(d + g.displayedSuffix)),
                    (u = b()));
              },
              execute: function () {
                window.grecaptcha &&
      ...
      660: function (e, t, a) {
        ...
        n = {
          urls: {
            getMetadata: "".concat(
              n.EnvironmentUrls.apiGatewayCdnUrl,
              "/captcha/v1/metadata"
            ),
            funCaptchaRedeem: {
              WebSignup: "".concat(
                n.EnvironmentUrls.captchaApi,
                "/v1/funcaptcha/signup/web"
              ),
              AppSignup: "".concat(
                n.EnvironmentUrls.captchaApi,
                "/v1/funcaptcha/signup/app"
              ),
              WebLogin: "".concat(
                n.EnvironmentUrls.captchaApi,
                "/v1/funcaptcha/login/web"
              ),
              AppLogin: "".concat(
                n.EnvironmentUrls.captchaApi,
                "/v1/funcaptcha/login/app"
              ),
          ...
          messages: {
            error:
              "We currently cannot verify CAPTCHA, please try again later.",
            funCaptchaError:
        ...
        t.A = function (e) {
          ...
          (this.provider = e),
            ...
            (this.startStatisticsSequence = function (e) {
              this.eventTimer.start(e),
                window.EventTracker && window.EventTracker.start(a(e));
            }),
            ...
            (this.logTriggered = function (e) {
              this.fireEvent(e, o.triggeredSuffix),
                this.startStatisticsSequence(
                  n(e + this.provider + o.completedTimeSequenceSuffix)
                );
            }),
      ...
      746: function (e, t, a) {
        ...
        var n = a(669),
          ...
          a = (function () {
            ...
            function c() {
              var e = s()("#game-card-redeem-captcha")
                .addClass("hidden")
                .detach();
                ...
                e &&
                  e.forEach(function (e) {
                    var t,
                      t = {
                        Type: a
                          ? (t = e.Type).charAt(0).toLowerCase() + t.slice(1)
                          : e.Type,
                        ApiUrl: e.ApiUrl,
