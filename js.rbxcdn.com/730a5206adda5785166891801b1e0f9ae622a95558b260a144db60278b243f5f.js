!(function () {
  ...
  (a.prototype.compile = function (t) {
    ...
    (a.prototype.compileArgument = function (t) {
      ...
      switch (e.type) {
        ...
        case "pluralFormat":
          return (
            (r = this.compileOptions(t)), new u(t.id, e.ordinal, e.offset, r, i)
          );
        case "selectFormat":
      ...
      })(t, Error),
      {
        ...
        parse: function (e) {
          var r,
            ...
            z = /^[1-9]/,
            U = { type: "class", value: "[1-9]", description: "[1-9]" },
            W = /^[^{}\\\0-\x1F \t\n\r]/,
            $ = {
              type: "class",
              value: "[^{}\\\\\\0-\\x1F\\x7f \\t\\n\\r]",
            ...
            H = { type: "literal", value: "\\u", description: '"\\\\u"' },
            K = 0,
            Q = 0,
            V = [{ line: 1, column: 1, seenCR: !1 }],
            X = 0,
            Y = [],
            tt = 0;
          if ("startRule" in a) {
          ...
          function tr(t) {
            ...
            for (r = t - 1; !V[r]; ) r--;
            for (
              o = { line: (o = V[r]).line, column: o.column, seenCR: o.seenCR };
              r < t;
            ...
            return (
              ...
              (n = (function () {
                ...
                return (
                  r !== l && ((Q = t), (r = c(r))),
                  (t = r) === l &&
                    ((t = K), (t = (r = tc()) !== l ? e.substring(t, K) : r)),
                  t
                );
              })()) !== l &&
                ((Q = r),
                (n = { type: "messageTextElement", value: n, location: te() })),
              (t = n) === l &&
                (t = (function () {
            ...
            return (
              ...
              tf() !== l &&
                ...
                c !== l && (f = th()) !== l
                  ? (s = c = [c, f])
                  : ((K = s), (s = l)),
                (u = s !== l ? e.substring(u, K) : s) === l && (u = ty()),
                (n = u) !== l &&
                  tf() !== l &&
                  (123 === e.charCodeAt(K)
                    ? ((o = "{"), K++)
              ...
              t === l &&
                ...
                r !== l &&
                  ...
                  (s = tm()) !== l
                    ? (o = i = [i, a, u, s])
                    : ((K = o), (o = l)),
                  (n = o !== l ? e.substring(n, K) : o) !== l))
                  ? ((Q = t), (t = r = String.fromCharCode(parseInt(n, 16))))
                  : ((K = t), (t = l))),
              t
            );
          }
          ...
          throw (
            (i !== l &&
              K < e.length &&
              to({ type: "end", description: "end of input" }),
            (r = Y),
            (n = X < e.length ? e.charAt(X) : null),
            (o = X < e.length ? tn(X, X + 1) : tn(X, X)),
            null !== r &&
              (function (t) {
                var e = 1;
                for (
            ...
            new t(
              (function (t, e) {
                ...
                return (
                  "Expected " +
                  (t.length > 1
                    ? n.slice(0, -1).join(", ") + " or " + n[t.length - 1]
                    : n[0]) +
                  " but " +
                  (e
                    ? '"' +
  ...
  function p(t, e, r) {
    ...
    (r = this._mergeFormats(p.formats, r)),
      Object.defineProperty(this, "_locale", { value: this._resolveLocale(e) });
  ...
  Object.defineProperty(p, "formats", {
    ...
    (p.prototype._format = function (t, e) {
      ...
      for (r = 0, n = t.length; r < n; r += 1) {
        ...
        if (((i = o.id), !(e && Object.prototype.hasOwnProperty.call(e, i))))
          throw Error("A value must be provided for: " + i);
        (a = e[i]),
          o.options
            ? (l += this._format(o.getOption(a), e))
            : (l += o.format(a));
      }
      return l;
    }),
  ...
  var m = "RobloxLocaleCode",
    ...
    w = function () {
      ...
      return (
        ...
        !t && e && (t = localStorage.getItem(m)),
        t || (t = "en_us"),
        e && localStorage.setItem(m, t),
        t
      );
    },
    F = {
        ...
        (t = [
          {
            key: "getTimeZone",
            value: function (t) {
              return new Intl.DateTimeFormat(this.locale, t).resolvedOptions()
                .timeZone;
            },
          },
          {
            ...
            value: function (t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : " | ";
              return (
                this.getCustomDateTime(t, T["0"]) +
                e +
                this.getCustomDateTime(t, T["1"])
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              var t = this.getShortDate(O),
                e = [
                  { type: "year", index: t.indexOf("2003") },
                  { type: "month", index: t.indexOf("8") },
                  { type: "day", index: t.indexOf("17") },
                ];
              return (
                e.some(function (t) {
                  return -1 === t.index;
  ...
  var E = (function () {
    ...
    function e(t, r, n) {
      ...
      var o,
        i = t || w();
      (this.locale = Object.prototype.hasOwnProperty.call(g, i)
        ? v(g[i])
        : v(i)),
    ...
    return (
      (t = [
          ...
          value: function () {
            return (
              this.dateTimeFormatter ||
                (this.dateTimeFormatter = new D(this.locale)),
              this.dateTimeFormatter
            );
          },
        },
              ...
              !(this.monthsList[n] && this.monthsList[n].length > 0) &&
                (this.monthsList[n] =
                  ...
                  A.map(function (t) {
                    ...
                    var i;
                    return b(r)
                      ? { value: o + 1, name: j(r, o + 1, e) }
                      : {
                          value: o + 1,
                          name: Intl.DateTimeFormat(r, { month: n }).format(t),
                        };
                  }))),
              this.monthsList[n]
            );
          ...
          value: function (t, e) {
            ...
            if (
              ...
              (void 0 === t ? "undefined" : P(t)) !== "object" ||
                !Date.prototype.isPrototypeOf(t))
            )
        ...
        },
        {
          ...
          value: function (t, e) {
            if (Number.isNaN(t))
              throw TypeError("The argument 'number' must be of type number");
            var r,
              n = {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            return (
              (this.weekdaysList[r] = n.map(function (t, n) {
                return {
                  value: n + 1,
                  name: Intl.DateTimeFormat(e.locale, { weekday: r }).format(t),
                };
              })),
              this.weekdaysList[r]
            );
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (this.monthsList[r] && this.monthsList[r].length > 0)
              return this.monthsList[r];
            var n = A.map(function (t) {
              return new Date(2017, t - 1);
            });
            return (
              (this.monthsList[r] = n.map(function (t, n) {
                return {
                  value: n + 1,
                  name: Intl.DateTimeFormat(e.locale, { month: r }).format(t),
                };
              })),
              this.monthsList[r]
            );
