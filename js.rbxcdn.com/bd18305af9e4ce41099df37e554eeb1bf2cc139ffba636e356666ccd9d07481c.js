!(function () {
  var n = {
        ...
        var p = {
          single_source_shortest_paths: function (e, t, n) {
            ...
            var a,
              ...
              u,
              d,
              f = p.PriorityQueue.make();
            for (f.push(t, 0); !f.empty(); )
              for (l in ((o = (a = f.pop()).value),
              (c = a.cost),
              (s = e[o] || {})))
                s.hasOwnProperty(l) &&
                  ((u = c + s[l]),
          ...
          PriorityQueue: {
            make: function (e) {
              ...
              return (
                (r.queue = []), (r.sorter = e.sorter || n.default_sorter), r
              );
            },
        ...
        e.exports = function (e) {
          for (var t = [], n = e.length, r = 0; r < n; r++) {
            ...
            55296 <= a &&
              ...
              i <= 57343 &&
              ((a = 1024 * (a - 55296) + i - 56320 + 65536), (r += 1)),
              a < 128
                ? t.push(a)
                : a < 2048
                ? (t.push((a >> 6) | 192), t.push((63 & a) | 128))
                : a < 55296 || (57344 <= a && a < 65536)
                ? (t.push((a >> 12) | 224),
                  t.push(((a >> 6) & 63) | 128),
                  t.push((63 & a) | 128))
                : 65536 <= a && a <= 1114111
      ...
      28: function (e, t, n) {
        ...
        function a(r, i, a, o, t) {
          ...
          if (!e) {
            ...
            return (
              1 === n
                ? ((a = i), (i = o = void 0))
                : 2 !== n || i.getContext || ((o = a), (a = i), (i = void 0)),
          ...
          2 === n
            ? ((t = a), (a = i), (i = o = void 0))
            : 3 === n &&
              (i.getContext && void 0 === t
                ? ((t = o), (o = void 0))
                : ((t = o), (o = a), (a = i), (i = void 0)));
          try {
            var l = s.create(a, o);
            t(null, r(l, i, o));
          } catch (e) {
        ...
        s.create,
          a.bind(null, r.render),
          (t.hz = a.bind(null, r.renderToDataURL)),
          a.bind(null, function (e, t, n) {
            return i.render(e, n);
          });
      },
      827: function (e) {
        ...
        (o.getRowColCoords = function (e) {
          ...
          for (
            var t = Math.floor(e / 7) + 2,
              e = a(e),
              n = 145 === e ? 26 : 2 * Math.ceil((e - 13) / (2 * t - 2)),
              r = [e - 7],
              i = 1;
            i < t - 1;
            i++
          ...
          (o.getPositions = function (e) {
            for (
              var t = [], n = o.getRowColCoords(e), r = n.length, i = 0;
              i < r;
              i++
            )
              for (var a = 0; a < r; a++)
      ...
      336: function (e, t, n) {
        ...
        t.getEncodedBits = function (e, t) {
          for (
            var t = (e.bit << 3) | t, n = t << 10;
            0 <= r.getBCHDigit(n) - i;

          )
            n ^= 1335 << (r.getBCHDigit(n) - i);
          return 21522 ^ ((t << 10) | n);
        };
      },
      376: function (e, t) {
      ...
      910: function (e, l) {
        ...
        (l.isValid = function (e) {
          ...
          (l.getPenaltyN1 = function (e) {
            for (
              var t = e.size, n = 0, r = 0, i = 0, a = null, o = null, l = 0;
              l < t;
              l++
            ) {
              a = o = null;
                    ...
                    (function (e, t, n) {
                      switch (e) {
                        ...
                        case l.Patterns.PATTERN100:
                          return (
                            (Math.floor(t / 2) + Math.floor(n / 3)) % 2 == 0
                          );
          ...
          (l.getBestMask = function (e, t) {
            for (
              var n = Object.keys(l.Patterns).length, r = 0, i = 1 / 0, a = 0;
              a < n;
              a++
            ) {
              t(a), l.applyMask(a, e);
      ...
      758: function (e, t, n) {
        ...
        (i.getBitsLength = function (e) {
          ...
          (i.prototype.write = function (e) {
            for (var t, n, r = 0; r + 3 <= this.data.length; r += 3)
              (t = this.data.substr(r, 3)), (n = parseInt(t, 10)), e.put(n, 10);
            var i = this.data.length - r;
            0 < i &&
              ((t = this.data.substr(r)),
              (n = parseInt(t, 10)),
              e.put(n, 3 * i + 1));
          }),
          (e.exports = i);
      ...
      378: function (e, r, t) {
        ...
        (r.mul = function (e, t) {
          for (
            var n = new Uint8Array(e.length + t.length - 1), r = 0;
            r < e.length;
            r++
          )
          ...
          (r.generateECPolynomial = function (e) {
            for (var t = new Uint8Array([1]), n = 0; n < e; n++)
      ...
      421: function (e, t, n) {
        ...
        function g(e, t, n) {
          for (
            var r, i = e.size, a = c.getEncodedBits(t, n), o = 0;
            o < 15;
            o++
          )
            (r = 1 == ((a >> o) & 1)),
        ...
        function h(t, e, n) {
          ...
          n =
            8 * (C.getSymbolTotalCodewords(t) - w.getTotalCodewordsCount(t, e));
          for (
            r.getLengthInBits() + 4 <= n && r.put(0, 4);
            r.getLengthInBits() % 8 != 0;

          )
            r.putBit(0);
          for (var i = (n - r.getLengthInBits()) / 8, a = 0; a < i; a++)
            r.put(a % 2 ? 17 : 236, 8);
          return (function (e, t, n) {
            for (
              var r = C.getSymbolTotalCodewords(t),
                i = w.getTotalCodewordsCount(t, n),
                i = r - i,
                a = w.getBlocksCount(t, n),
                o = a - (r % a),
                n = Math.floor(r / a),
                l = Math.floor(i / a),
                c = l + 1,
            ...
            for (y = 0; y < s; y++) for (b = 0; b < a; b++) E[A++] = p[b][y];
            return E;
          })(r, t, e);
        }
        function v(e, c, t, n) {
          ...
          if (Array.isArray(e)) r = m.fromArray(e);
            ...
            var i,
              a = c;
            a || ((i = m.rawSplit(e)), (a = f.getBestVersionForData(i, t))),
              (r = m.fromString(e, a || 40));
          }
          ...
          return (
            (function (e) {
              for (
                var t = e.size, n = u.getPositions(c), r = 0;
                r < n.length;
                r++
              )
            ...
            7 <= c &&
              (function (e) {
                for (
                  var t, n, r, i = e.size, a = f.getEncodedBits(c), o = 0;
                  o < 18;
                  o++
                )
                  (t = Math.floor(o / 3)),
            ...
            isNaN(n) && (n = d.getBestMask(e, g.bind(null, e, t))),
            d.applyMask(n, e),
            g(e, t, n),
            {
              modules: e,
        ...
        t.create = function (e, t) {
          ...
          return (
            void 0 !== t &&
              ((i = a.from(t.errorCorrectionLevel, a.M)),
              (n = f.from(t.version)),
              (r = d.from(t.maskPattern)),
              t.toSJISFunc && C.setToSJISFunction(t.toSJISFunc)),
            v(e, n, i, r)
          );
        };
      },
      ...
      59: function (e, o, t) {
        ...
        function p(e) {
          var t,
            n = f(c.NUMERIC, m.NUMERIC, e),
            r = f(c.ALPHANUMERIC, m.ALPHANUMERIC, e),
            e = s.isKanjiModeEnabled()
              ? ((t = f(c.BYTE, m.BYTE, e)), f(c.KANJI, m.KANJI, e))
              : ((t = f(c.BYTE_KANJI, m.BYTE, e)), []);
          return n
            .concat(r, t, e)
            .sort(function (e, t) {
        ...
        function n(e, t) {
          ...
          switch (
            (t !== m.KANJI || s.isKanjiModeEnabled() || (t = m.BYTE), t)
          ) {
            case m.NUMERIC:
              return new r(e);
            case m.ALPHANUMERIC:
          ...
          (o.fromString = function (e, t) {
            for (
              var n = (function (e, t) {
                  for (
                    ...
                    for (var o = e[a], l = [], c = 0; c < o.length; c++) {
                      var s = o[c],
                        u = "" + a + c;
                      l.push(u),
                        (n[u] = { node: s, lastCount: 0 }),
                        (r[u] = {});
                      for (var d = 0; d < i.length; d++) {
                        var f = i[d];
                        n[f] && n[f].node.mode === s.mode
                          ? ((r[f][u] =
                              g(n[f].lastCount + s.length, s.mode) -
                              g(n[f].lastCount, s.mode)),
                            (n[f].lastCount += s.length))
                          : (n[f] && (n[f].lastCount = s.length),
                            (r[f][u] =
                              g(s.length, s.mode) +
                              4 +
                              m.getCharCountIndicator(s.mode, t)));
                      }
                    }
                    i = l;
                  }
                    ...
                    for (var t = [], n = 0; n < e.length; n++) {
                      ...
                      switch (r.mode) {
                        ...
                        case m.KANJI:
                          t.push([
                            r,
                            { data: r.data, mode: m.BYTE, length: d(r.data) },
                          ]);
                          break;
                        case m.BYTE:
                          t.push([
                ...
                r = u.find_path(n.map, "start", "end"),
                i = [],
                a = 1;
              a < r.length - 1;
              a++
            )
              i.push(n.table[r[a]].node);
            return o.fromArray(
      ...
      701: function (e, i, t) {
        ...
        (i.from = function (e, t) {
          ...
          (i.getCapacity = function (e, t, n) {
            ...
            t =
              8 *
              (a.getSymbolTotalCodewords(e) - o.getTotalCodewordsCount(e, t));
          ...
          (i.getEncodedBits = function (e) {
            ...
            for (var t = e << 12; 0 <= a.getBCHDigit(t) - n; )
              t ^= 7973 << (a.getBCHDigit(t) - n);
            return (e << 12) | t;
          });
      },
      895: function (e, r, t) {
      ...
      398: function (e, t, n) {
        ...
        function l(e, t) {
          var n = e.a / 255,
            e = t + '="' + e.hex + '"';
          return n < 1
            ? e + " " + t + '-opacity="' + n.toFixed(2).slice(1) + '"'
            : e;
        }
        function u(e, t, n) {
          t = e + t;
        ...
        t.render = function (e, t, n) {
          var r = o.getOptions(t),
            ...
            i =
              "<path " +
              l(r.color.dark, "stroke") +
              ' d="' +
              (function (e, t, n) {
                for (
                  var r = "", i = 0, a = !1, o = 0, l = 0;
                  l < e.length;
                  l++
                ) {
                  ...
                  c || a || (a = !0),
                    e[l]
                      ? (o++,
                        (0 < l && 0 < c && e[l - 1]) ||
                          ((r += a ? u("M", c + n, 0.5 + s + n) : u("m", i, 0)),
                          (i = 0),
                          (a = !1)),
                        (c + 1 < t && e[l + 1]) || ((r += u("h", o)), (o = 0)))
                      : i++;
                }
                return r;
              })(a, i, r.margin) +
      ...
      467: function (e, p) {
        ...
        (p.getOptions = function (e) {
          ...
          (p.qrToImageData = function (e, t, n) {
            for (
              var r = t.modules.size,
                i = t.modules.data,
                a = p.getScale(r, n),
                o = Math.floor((r + 2 * n.margin) * a),
                l = n.margin * a,
              ...
              for (var u = 0; u < o; u++) {
                ...
                l <= s &&
                  ...
                  (f =
                    c[
                      i[Math.floor((s - l) / a) * r + Math.floor((u - l) / a)]
                        ? 1
                        : 0
                    ]),
                  (e[d++] = f.r),
  ...
  (en.n = function (e) {
    ...
    (function () {
      ...
      function Se() {
        ...
        return S.httpService.post(e, { generateLink: !0 }).then(
          function (e) {
            return e.data;
          },
          function () {
      ...
      function Le(e, t) {
        o.eventStreamService.sendEventWithTarget(
          e.type,
          e.context,
          b(b({}, e.params), {}, { origin: t.origin })
        );
      }
          ...
          x().createElement(
            ...
            x().createElement(
              ...
              x().createElement(
                ...
                x().createElement("span", { className: "close icon-close" })
              ),
              x().createElement(
                k.Modal.Title,
                  ...
                  ? x().createElement(
                      ...
                      x().createElement(
                        ...
                        x().createElement("span", {
                          className:
                            t === a ? "spinner spinner-sm" : "icon-checkmark",
                        })
                      ),
                      x().createElement(
                        "span",
            ...
            !l &&
              x().createElement(
                "a",
                {
                  href: r,
                  onClick: function () {
                    Le(j.verificationLinkClicked, { origin: o });
                  },
                  target: "_blank",
                  rel: "noreferrer",
                },
      ...
      function Be(e, t) {
        var n = {
          ...
          t = { isUserOptIn: e, isOptedInThroughUpsell: t };
      ...
      function tt(e, t) {
        ...
        switch (t.type) {
          case I:
            return ze(ze({}, e), {}, { userEmailInput: "" });
          case P:
            return ze(
              ze({}, e),
              {},
              { origin: t.origin, skipCallback: t.skipCallback }
            );
          case N:
            return ze(
              ze({}, e),
          ...
          case T:
            return (
              t.pageName === F
                ...
                : t.pageName === _
                ? (Le(j.successPage, { origin: e.origin }),
                  (o = ["Label.DateOfBirthUpdated"]),
                  t.isSeventeenPlus && o.push("Label.AccessWiderVariety"),
                  (n = {
                    ...
                    buttonStack: [
                      {
                        ...
                        text: "Action.Close",
                        callback: function () {
                          Le(j.successPageClose, { origin: e.origin }),
                            t.close();
                        },
                      },
                    ],
                    ...
                    buttonStack: [
                      {
                        ...
                        callback: function () {
                          t.dispatch({ type: T, pageName: Q }), t.poll();
                        },
                      },
                    ],
                ...
                : t.pageName === z
                ? (Le(j.failurePage, { origin: e.origin }),
                  (n = {
                    ...
                    buttonStack: [
                      {
                        ...
                        text: "Action.Close",
                        callback: function () {
                          Le(j.failurePageClose, { origin: e.origin }),
                            t.close();
                        },
                      },
                    ],
                ...
                : t.pageName === J
                ? (Le(j.tempBanPage, { origin: e.origin }),
                  (n = {
                    heading: "Heading.Error",
                    icon: "failure-icon",
                    ...
                    buttonStack: [
                      {
                        ...
                        text: "Action.OK",
                        callback: function () {
                          Le(j.tempBanPageClose, { origin: e.origin }),
                            t.close();
                        },
                      },
                    ],
                ...
                : t.pageName === W
                ? (t.useQRCode && Le(j.showQRCode, { origin: e.origin }),
                  (n = {
                ...
                : t.pageName === G
                ? (n = {
                    communityStandardsUrl: S.urlService.resolveUrl(
                      Ke,
                ...
                : t.pageName === X &&
                  (n = {
                    ...
                    facialPrivacyUrl: S.urlService.resolveUrl(
                      Ke,
              ...
              ze(ze({}, e), {}, { pageName: t.pageName, pageState: n })
            );
          case V:
            return ze(ze({}, e), {}, { errorMsg: t.errorMsg });
          case U:
            return ze(ze({}, e), {}, { isEmailUpdating: t.isEmailUpdating });
          case R:
            return e.pageName === q
              ? ze(ze({}, e), {}, { userEmailInput: t.value, errorMsg: "" })
              : e;
          case L:
          ...
          case M:
            return ze(
              ze({}, e),
              {},
              { closeCallback: t.callback, callbackReady: !0 }
            );
          case B:
            return ze(ze({}, e), {}, { callbackReady: !0 });
          case O:
            return (
              e.callbackReady &&
                ((a =
                  (i = e.pageName === _ || e.pageName === F) ||
                  e.pageName === H),
                (l = i),
                (r = a),
                c.Hybrid &&
                ...
                e.closeCallback && e.closeCallback(i, a)),
              ze({}, $e)
            );
          default:
            return e;
      ...
      function nt(e) {
        ...
        return x().createElement(
          et.Provider,
          { value: { idVerificationState: e, dispatch: n } },
          t
        );
      }
      function rt() {
      ...
      function it(e) {
        ...
        return x().createElement(
          ...
          x().createElement(
            k.Modal.Body,
            null,
            x().createElement("div", { className: "email-upsell-image" }),
            x().createElement(
              "p",
      ...
      (nt.propTypes = { children: n().node.isRequired }),
        (it.propTypes = {
          translate: n().func.isRequired,
          onHide: n().func.isRequired,
            ...
            i
              ? x().createElement(
                  ...
                  x().createElement(
                    ...
                    n(r, { linkStart: "", linkEnd: "" })
                  )
                )
              : x().createElement(
                  "span",
                  null,
                  n(t, { linkStart: "", linkEnd: "" })
                )
          ),
          e.map(function (e) {
      ...
      function mt(e) {
        ...
        return (
          ...
          x().createElement(
            ...
            x().createElement(k.Modal.Footer, null, s),
            x().createElement(
              "div",
              {
                className:
                  "text-footer legal-enable-page-text-footer border-top",
              },
              x().createElement(
                "span",
                null,
                x().createElement("div", { className: "icon-moreinfo" }),
                x().createElement(
                  "a",
                  {
      ...
      function bt(e) {
        ...
        (e = o === te || o === ne ? "_self" : "_blank"),
          (l =
            o === te || ne
              ? "".concat(r, "&redirect-uri=").concat(encodeURIComponent(l))
              : r);
        return x().createElement(
          x().Fragment,
          null,
          x().createElement(
            ...
            x().createElement(
              ...
              x().createElement(
                k.Modal.Title,
                { id: "contained-modal-title-vcenter" },
                t("Heading.IdentityVerification")
              )
            )
          ),
          x().createElement(
            ...
            x().createElement(
              ...
              x().createElement(
                ...
                x().createElement("span", { className: "icon-menu-document" }),
                x().createElement(
                  "div",
              ...
              c &&
                x().createElement(
                  "div",
                  { className: "preparation-list-item" },
                  x().createElement("span", { className: "icon-menu-mobile" }),
                  x().createElement(
                    "div",
                    { className: "preparation-list-text" },
                    x().createElement(
                      "div",
                      { className: "preparation-title" },
                      t("Label.UseSmartphone")
                    ),
                    x().createElement(
                      "div",
                      { className: "preparation-text" },
                      t("Label.SmartphoneRequired")
                    )
                  )
                )
            ),
            ...
            !c &&
              x().createElement(
                "a",
                {
                  href: l,
                  onClick: function () {
                    Le(j.verificationLinkClicked, { origin: a });
                  },
                  target: e,
                  rel: "noreferrer",
                },
      ...
      function wt(e) {
        ...
        return x().createElement(
          ...
          x().createElement(
            k.Modal.Body,
            null,
            i && x().createElement("div", { className: i }),
            x().createElement(
              "ul",
                ...
                ? a.map(function (e) {
                    return x().createElement("li", {
                      dangerouslySetInnerHTML: {
                        __html: n(e, {
                          spanStart:
                            "<a class='text-link' href='/info/privacy'>",
                          spanEnd: "</a>",
                          boldStart: "<b>",
                          boldEnd: "</b>",
                        }),
      ...
      function xt() {
        ...
        return S.httpService.post(e).then(
          function () {
            return !0;
          },
          function () {
        ...
        return (
          ...
          x().createElement(
            ...
            x().createElement(
              k.Modal.Footer,
              null,
              x().createElement("div", { className: "half-flex-container" }, l)
            ),
            x().createElement(
              "div",
              {
      ...
      function Qt(e) {
        ...
        function h() {
          m({ type: O }),
            d(!1),
            (g.current = ""),
            p === Z && i === _ && document.location.reload();
        }
        function f() {
          Le(j.exitIdentityVerification, { origin: p }), h();
        }
        function v(e) {
                    ...
                    case 2:
                      (t = e.sent),
                        ...
                        t && t.verificationLink && t.sessionIdentifier
                          ? (Le(j.showModal, { origin: p }),
                            (r = t.verificationLink),
                            p === te
                              ? ((i = S.urlService.getQueryParam("wid")),
                                (n = S.urlService.getUrlWithQueries(xe, {
                                  wid: i,
                                  action: "IdVerifyPending",
                                })))
                              : p === ne &&
                                ((i = window.location.href),
                                (n = "".concat(i, "&action=IdVerifyPending"))),
                            m({
                              type: T,
                              pageName: W,
                              verificationLink: r,
                                    ...
                                    return regeneratorRuntime.wrap(function (
                                      ...
                                      for (;;)
                                        switch ((e.prev = e.next)) {
                                          ...
                                          case 27:
                                            return (
                                              (a = K), e.abrupt("break", 40)
                                            );
                                          case 29:
                                            return (
                                              (a = _), e.abrupt("break", 40)
                                            );
                                          case 31:
                                            return (
                                              Le(j.verificationInProgress, {
                                                origin: p,
                                              }),
                                              (l = ye),
                                              e.abrupt("break", 40)
                            ...
                            })(t.sessionIdentifier, t.verificationLink))
                          : 0 <
                            (null == t ? void 0 : t.daysUntilNextVerification)
                          ? m({
                              type: T,
                              pageName: J,
                              daysUntilNextVerification:
                                t.daysUntilNextVerification,
                              dispatch: m,
                              close: function () {
                                h();
                              },
        ...
        function b() {
          ...
          r.pageName === q
            ? ((t = r.userEmailInput),
              /\S+@\S+\.\S+/.test(t)
                ? (Le(j.addEmailConfirm, { origin: p }),
                  m({ type: U, isEmailUpdating: !0 }),
                  (e = { emailAddress: r.userEmailInput }),
                  (t = C()),
                  S.httpService
                    .post(t, e)
                    .then(
                    ...
                    .then(function (e) {
                      e === Ue.InvalidEmailCode
                        ? (m({ type: V, errorMsg: Kt }),
                          m({ type: U, isEmailUpdating: !1 }))
                        : ((e = C()),
                          S.httpService
                            .get(e)
                            .then(
          ...
          (e = C()),
            S.httpService
              ...
              .then(
                function (e) {
                  e &&
                    (m({ type: P, origin: p, skipCallback: !1 }),
                    m({
                      type: N,
                    ...
                    e.emailAddress
                      ? c(!0)
                      : (Le(j.showAddEmailModal, { origin: p }),
                        m({ type: T, pageName: q, dispatch: m }),
                        m({ type: L }),
                        d(!0)));
                },
                function () {
          ...
          (0, w.useEffect)(function () {
            m({ type: P, origin: p, skipCallback: !1 }),
              window.addEventListener(
                we,
                function (e) {
                  m({ type: M, callback: e.detail.successCallback }),
                    ke().then(function (e) {
                      null != e && e.isVerified
                        ? (d(!0), v(e))
                        : p === ee
              ...
              window.addEventListener(Ae, function (e) {
                var t = e.detail,
          ...
          a &&
            (A =
              i === W
                ? x().createElement(
                    Et,
                    Ot({}, a, { onHide: o, translate: t, entry: p })
                  )
                : i === Q
                ? x().createElement(Ve, Ot({}, a, { onHide: o, translate: t }))
                : i === G
                ? ((s = Bt(
                    {
                  ...
                  a.useVoiceUpsellV2Design && ((e = "md"), (n = !0)),
                  x().createElement(gt, Ot({}, s, { translate: t })))
                : i === X
                ? ((e = "md"),
                  x().createElement(It, Ot({}, a, { onHide: o, translate: t })))
                : x().createElement(
                    St,
                    Ot({}, a, { onHide: o, translate: t })
                  )),
          x().createElement(
            "div",
            null,
              ...
              i === q
                ? x().createElement(at, {
                    ...
                    onSecondaryAction: function () {
                      r.pageName === q &&
                        (r.skipCallback && r.skipCallback(),
                        m({ type: I }),
                        d(!1));
                    },
                    onInputFocus: function () {
                      Le(j.useAddEmailField, { origin: p });
                    },
                    onInputChange: function (e) {
                      m({ type: R, pageName: q, value: e });
                    },
                    onKeyDown: function (e) {
                      return e === Ue.Enter && b();
                    },
      ...
      function Jt(e) {
        ...
        return x().createElement(
          nt,
          null,
          x().createElement(Yt, { translate: t, entry: e })
        );
      }
      (Jt.defaultProps = { entry: ee }),
        (Jt.propTypes = { translate: n().func.isRequired, entry: n().string });
                ...
                switch ((e.prev = e.next)) {
                  case 0:
                    (t = document.getElementById(i))
                      ? ((n = t.getAttribute("entry")),
                        (0, r.render)(
                          x().createElement(Wt, { entry: n || void 0 }),
                          t
                        ))
