            ...
            for (var e = [], t = 0; t < arguments.length; t++) {
              ...
              if (n) {
                ...
                if ("string" == o || "number" == o) e.push(n);
                  ...
                  !n.length || ((r = c.apply(null, n)) && e.push(r));
                else if ("object" == o)
                  if (
    ...
    (function () {
      ...
      function o(e) {
        var t = e.amount,
          ...
          r = s()("price-tag", r);
        try {
          var i = (c = Intl.NumberFormat().resolvedOptions().locale).startsWith(
              p
            )
        ...
        var t,
          ...
          e =
            null !== (e = null == r ? void 0 : r.amount) && void 0 !== e
              ? e
              : parseFloat(
                  null !== (t = null == n ? void 0 : n.amount) && void 0 !== t
                    ? t
                    : String()
                ),
          n =
      ...
      (0, t.ready)(function () {
        window.addEventListener("price-tag:render", function (e) {
          var n,
            e = e.detail;
          (e =
            null !== (e = null == (n = e) ? void 0 : n.targetSelector) &&
            void 0 !== e
              ? e
              : ".fiat-price-tag"),
            ...
            e.forEach(function (e) {
              var t = e.dataset;
              (0,
              r.render)(l().createElement(v, { containerDataset: t, options: n }), e);
            });
        });
      });
    })();
