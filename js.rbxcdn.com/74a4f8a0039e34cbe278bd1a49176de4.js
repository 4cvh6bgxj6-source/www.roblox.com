...
var RobloxError = (function () {
  ...
  return RobloxError;
})(); // ~/Generated/js/Roblox_TranslationResources_CommonUI_ControlsResources_it_it_standard.js
    ...
    close: function () {
      ...
      if ($.isFunction(s.o.onClose) && !s.occb) {
        ...
        if (s.d.placeholder) {
          ...
          if (s.o.persist) {
            ph.replaceWith(
              s.d.data.removeClass("simplemodal-data").css("display", s.display)
            );
          } else {
