!(function () {
  ...
  function b(e) {
    ...
    t = l
      ? r().createElement("div", {
          className:
            "cross-device-login-device-specific-instruction-text font-caption-header",
    ...
    return a
      ? r().createElement(
          ...
          r().createElement(
            "div",
            null,
            r().createElement("b", null, i("Label.QrHeader"))
          ),
          r().createElement("img", {
            src: a,
            alt: "",
          ...
          r().createElement(
            ...
            {
              className:
                "cross-device-login-instruction-text font-caption-header",
            },
      ...
      r().createElement(
        ...
        r().createElement(
          ...
          r().createElement(
            ...
            {
              className:
                "cross-device-login-display-code-modal-title-container",
            },
            r().createElement(
              "button",
              {
  ...
  function j() {
    var e = document.getElementById(
      "crossDeviceLoginDisplayCodeModal-container"
    );
    e
      ? (0, a.render)(r().createElement(O, null), e)
