!(function () {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 17:
                      ...
                      break;
                    case 21:
                      if (t.doesUserNeedToAcceptAgreements)
                        return e.abrupt("return", !0);
                      e.next = 24;
                      break;
                    case 24:
                      return (
                        (a = r.getTime()), (e.prev = 25), (e.next = 28), T()
                      );
                    case 28:
      ...
      if (r instanceof Date) n.lastFetchTimestamp = r.toISOString();
        ...
        try {
          ...
          if (e instanceof SyntaxError)
            return void w.localStorageService.removeLocalStorage(g);
          throw e;
        }
      try {
        ...
        console.error(
          "Error updating doesUserNeedToAcceptAgreements ".concat(e)
        );
      }
    },
  };
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 6:
                      (e.prev = 6),
                        (e.t0 = e.catch(0)),
                        console.error(
                          "Error accepting user agreements ".concat(e.t0)
                        );
                    case 9:
                    case "end":
                      return e.stop();
  ...
  (e = function (e) {
    ...
    return (
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 7:
                          (e.prev = 7),
                            (e.t0 = e.catch(1)),
                            console.error(
                              "Error calling shouldFetchAgreements ".concat(
                                e.t0
                              )
                            );
                        case 10:
                        ...
                        case 19:
                          (e.prev = 19),
                            (e.t1 = e.catch(11)),
                            console.error(
                              "Error fetching or caching user agreements ".concat(
                                e.t1
                              )
                            );
                        case 22:
      ...
      0 < e.length
        ? i().createElement(I, { translate: r, agreements: e })
        : null
    );
