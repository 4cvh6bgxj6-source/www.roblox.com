...
Roblox.LangDynamicDefault["Authentication.ResetPassword"] = {
  ...
  "Response.UpdatePasswordInputMissing":
    "Must include new password and confirm password",
  ...
  MessageCaptchaFailError:
    "The words you typed didn't match the picture. Please try again.",
  MessageUnknownSystemError: "System error. Please return to login screen.",
  MessageSamlUnauthenticated:
    "You must log in to Roblox to finish authenticating.",
  ...
  MessageAccountRecoveryUnknownError:
    "System error. Account could not be restored to this state.",
  MessageNoAccountsLinkedToEmail:
    "There are no accounts linked to this email address",
  ...
  MessageForgotPasswordFeatureDisabled:
    "Feature temporarily disabled. Please try again later.",
  ...
  "Description.PasswordChangeEmail.From":
    '"Roblox Password Reset" {fromEmailAddress}',
  ...
  "Description.AccountRecoveryPrompt.Body":
    "Would you like to recover your account?",
  "Message.AccountSecurityTicketExpired":
    "The account security ticket is expired.",
  MessageDifferentPasswordComplex:
    "Please use a different password. Use any special characters or numbers.",
  MessageDifferentPasswordComplexShort:
  ...
  "Description.EmailToRecoverAccount":
    "Enter your email to recover your Roblox account",
  "Description.PhoneToRecoverAccount":
    "Enter your phone number to recover your Roblox account",
  "Label.Phone": "Phone",
};
window.Roblox &&
