!(function () {
  ...
  function r(e, t) {
    ...
    switch (t.type) {
      ...
      case M.SET_CHECKBOX_AND_CONTINUE_BUTTON_STATE:
        return (
          (n.isContinueButtonEnabled = t.isContinueButtonEnabled),
          (n.isCheckboxEnabled = t.isCheckboxEnabled),
          n
        );
      case M.SET_ERROR:
  ...
  function Z(e) {
    ...
    ((e = {}).field = n),
      ...
      r && (e.state = r),
      o && (e.origin = o),
      le.eventStreamService.sendEventWithTarget(
        se.schematizedEventTypes.authFormInteraction,
        t,
        e
      );
  }
  function a(e) {
    var t;
    return (
      (((t = {})[se.context.validateOTP] = se.context.schematizedEnterOTP),
      (t[se.context.enterOTP] = se.context.schematizedEnterOTP),
      (t[se.context.sendOTP] = se.context.schematizedSendOTP),
      t)[e] || e
    );
  }
  function ee(e) {
    ...
    ((e = {}).field = n),
      ...
      r && (e.errorCode = r),
      a && (e.origin = a),
      le.eventStreamService.sendEventWithTarget(ue.formInteraction, t, e);
  }
  function te(e, t, n) {
    ee({
      ctx: e,
      ...
      le.eventStreamService.sendEventWithTarget(
        se.schematizedEventTypes.authMsgShown,
        a(e),
        {
          field:
            e === se.context.enterOTP
              ? se.field.resendErrorMessage
              : se.field.errorMessage,
          errorCode: t,
          origin: n,
        }
      );
  ...
  function ne(e, t, n) {
    le.eventStreamService.sendEventWithTarget(ue.buttonClick, e, {
      ...
      le.eventStreamService.sendEventWithTarget(
        se.schematizedEventTypes.authButtonClick,
        a(e),
        { btn: t, origin: n }
      );
  }
  ...
  function ie(e, t) {
    le.eventStreamService.sendEventWithTarget(
      se.schematizedEventTypes.authPageLoad,
      a(e),
      { origin: t }
    );
  }
  ...
  ((n = M = M || {})[(n.SET_ENTER_EMAIL_PAGE = 0)] = "SET_ENTER_EMAIL_PAGE"),
    (n[(n.SET_ENTER_CODE_PAGE = 1)] = "SET_ENTER_CODE_PAGE"),
    (n[(n.SET_EMAIL = 2)] = "SET_EMAIL"),
    (n[(n.SET_SESSION_TOKEN = 3)] = "SET_SESSION_TOKEN"),
    (n[(n.SET_OTP_CODE = 4)] = "SET_OTP_CODE"),
    (n[(n.SET_LEGAL_CHECK = 5)] = "SET_LEGAL_CHECK"),
    (n[(n.SET_CODE_VALID = 6)] = "SET_CODE_VALID"),
    (n[(n.SET_LOADING = 7)] = "SET_LOADING"),
    (n[(n.SET_CHECKBOX_AND_CONTINUE_BUTTON_STATE = 8)] =
      "SET_CHECKBOX_AND_CONTINUE_BUTTON_STATE"),
    (n[(n.SET_ERROR = 9)] = "SET_ERROR"),
    (n[(n.CLOSE_MODAL = 10)] = "CLOSE_MODAL");
  var c = {
    ...
    n = { common: ["Common.Captcha"], feature: "Authentication.Login" },
    se = {
    ...
    de = (0, I.withTranslations)(function (e) {
      ...
      (0, R.useEffect)(
        function () {
          ...
          d &&
            ...
            (h(!1),
            (e = n),
            ee({ ctx: se.context.sendOTP, field: se.field.email, origin: e }),
            Z({
            ...
            !C(p) && 0 < p.length
              ? u({ type: M.SET_ERROR, errorMessage: s(S) })
              : u({ type: M.SET_ERROR, errorMessage: "" });
        },
        [p]
      ),
        (0, R.useEffect)(
      ...
      return (
        ...
        N().createElement(
          R.Fragment,
          null,
          N().createElement(D.Modal.Header, {
            title: o,
            onClose: function () {
          ...
          N().createElement(
            ...
            N().createElement("input", {
              ...
              onChange: function (e) {
                return (
                  (e = e.target.value), void u({ type: M.SET_EMAIL, email: e })
                );
              },
              type: "email",
              autoFocus: !0,
            ...
            N().createElement(
              ...
              {
                className:
                  "text-error input-validation email-verify-code-error-text",
              },
              a
            ),
            N().createElement(
    ...
    he = (0, I.withTranslations)(
      function (e) {
        ...
        function o(e) {
          var t, n, o;
          v({ type: M.SET_LEGAL_CHECK, isChecked: e.target.checked }),
            (t = x),
            (n = se.btn.parentalConsentCheckbox),
            (o = e.target.checked),
            (e = i),
            le.eventStreamService.sendEventWithTarget(ue.buttonClick, t, {
              btn: n,
          ...
          N().createElement(
            ...
            N().createElement(
                ...
                ? N().createElement(
                    ...
                    N().createElement(
                      ...
                      N().createElement(
                        ...
                        {
                          className:
                            "email-verify-code-change-email-link text-link",
                          type: "button",
                          onClick: function () {
                            v({ type: M.SET_ENTER_EMAIL_PAGE }),
              ...
              N().createElement("input", {
                ...
                onChange: function (e) {
                  return (function (e) {
                    v({ type: M.SET_ERROR, errorMessage: "" });
                    e = e.replace(/\D/g, "");
                    v({ type: M.SET_OTP_CODE, code: e });
                  })(e.target.value);
                },
                type: "text",
                inputMode: "numeric",
              ...
              N().createElement(function () {
                return C
                  ? N().createElement(D.Loading, null)
                  : N().createElement(
                      D.Button,
                      {
                        className: "email-verify-code-button",
              ...
              N().createElement(function () {
                return c
                  ...
                  : N().createElement(
                      ...
                      {
                        className:
                          "font-caption-header email-verify-code-help-link",
                      },
                      N().createElement(
                        "a",
                        {
    ...
    v = (0, I.withTranslations)(function (e) {
      ...
      (0, R.useEffect)(
        function () {
          n && !l && w.length === t
            ? (A(),
              k({ type: M.SET_LOADING, isLoading: !0 }),
              ne(se.context.enterOTP, se.btn.login, u))
            : l &&
              k({
        ...
        (0, R.useEffect)(
          function () {
            l && o && O
              ? (k({ type: M.CLOSE_MODAL }),
                oe(se.context.enterOTP, se.aType.dismissed, u),
                ne(se.context.enterOTP, se.btn.signup, u),
                o({ otpSessionToken: T, otpContactType: Q }))
              : O && n && (k({ type: M.CLOSE_MODAL }), n(T, w));
          },
          [O]
        ),
        (0, R.useEffect)(function () {
          function e(e) {
            if (e.detail) {
              ...
              k({ type: M.SET_ERROR, errorMessage: e.detail.errorMessage });
            }
            k({ type: M.SET_OTP_CODE, code: "" }),
              k({ type: M.SET_LOADING, isLoading: !1 });
          }
          return (
            window.addEventListener("onEnterEmailVerifyCodeError", e),
            function () {
      ...
      function x(e, t) {
        ...
        return (
          k({ type: M.SET_LOADING, isLoading: !1 }),
          n === X
            ? (k({ type: M.SET_ERROR, errorMessage: d(z) }),
              void te(t, String(n), u))
            : n === Y
            ? (k({ type: M.SET_ERROR, errorMessage: d(H) }),
              void te(t, String(n), u))
            : n === $
            ? (k({ type: M.SET_ERROR, errorMessage: d(j) }),
              void te(t, String(n), u))
            : e === J
            ? (k({ type: M.SET_ERROR, errorMessage: d(z) }),
              void te(t, String(e), u))
            : n === q
            ? (te(t, String(n), u), void L())
            : (te(t, String(n), u),
              void k({ type: M.SET_ERROR, errorMessage: d(W) }))
        );
      }
      var P = function () {
          i(), k({ type: M.CLOSE_MODAL });
        },
        L = function () {
              ...
              switch (e.label) {
                case 0:
                  return (
                    ...
                    [
                      4,
                      ((n = { origin: u, contactType: Q, contactValue: S }),
                ...
                case 1:
                  return (
                    ...
                    k({
                      ...
                      sessionToken:
                        null !== (t = null == t ? void 0 : t.otpSessionToken) &&
                        void 0 !== t
                          ? t
                          : "",
                    }),
                    k({ type: M.SET_ERROR, errorMessage: "" }),
                    k({ type: M.SET_ENTER_CODE_PAGE }),
                    [3, 3]
                  );
                case 2:
            ...
            return fe(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  return (
                    e.sent(),
                    k({ type: M.SET_CODE_VALID, isCodeValid: !0 }),
                    [3, 3]
                  );
                case 2:
                ...
                return pe(void 0, void 0, void 0, function () {
                  ...
                  return fe(this, function (e) {
                    switch (e.label) {
                      ...
                      case 1:
                        return (
                          ...
                          k({
                            ...
                            sessionToken:
                              null !==
                                (t = null == t ? void 0 : t.otpSessionToken) &&
                              void 0 !== t
                                ? t
                                : "",
                          }),
                      ...
                      case 2:
                        return (
                          (t = e.sent()), x(t, se.context.enterOTP), [3, 3]
                        );
                      case 3:
                        return [2];
                    }
  ...
  Object.assign(e(), { EmailVerifyCodeModalService: n });
})();
