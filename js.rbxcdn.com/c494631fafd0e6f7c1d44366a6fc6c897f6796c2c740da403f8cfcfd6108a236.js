...
Roblox.LangDynamicDefault["Authentication.CrossDevice"] = {
  ...
  "Label.DevicePrompt":
    "GO TO YOUR LOGGED IN DEVICE TO ENTER THIS CODE AND EXPLORE",
  "Label.LoginInstructions": "On your logged in device, go to:",
  "Label.LoginLocation":
    "<b>Account Settings > Quick Log In</b> to enter your code.",
  ...
  "Action.OpenAlphaNumericModal":
    "Or click to generate a Quick Log In Code instead",
  ...
  "Label.LoginLocationV2":
    "<b>More Page > Quick Sign In</b> to enter your code.",
