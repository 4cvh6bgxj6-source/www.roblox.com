!(function () {
          ...
          l().createElement(
            ...
            l().createElement(
              "button",
              {
                type: "button",
                className:
                  "btn-primary-lg btn-full-width account-recovery-yes-button",
                onClick: e,
              },
              r("Action.Yes")
            )
          ...
          l().createElement(
            ...
            l().createElement(
              "button",
              {
                type: "button",
                className:
                  "btn-secondary-lg btn-full-width account-recovery-no-button",
                onClick: n,
              },
              r("Action.No")
            )
  ...
  function E(e) {
    b.eventStreamService.sendEventWithTarget(
      e.type,
      e.context,
      h({}, e.params)
    );
    ...
    return (
      (0, i.useEffect)(function () {
        ...
        (n = function (e) {
          ...
          c.httpService
            .post(g.apiUrls.enrollAbtestingApi, e)
            .then(function (e) {
              var t;
              e.data &&
                e.data.data &&
      ...
      l().createElement(y, {
        ...
        onPrimaryAction: function () {
          return (
            E(v.yesButtonClick),
            void (window.location.href = p.forgotCredentials)
          );
        },
        onHide: function () {
