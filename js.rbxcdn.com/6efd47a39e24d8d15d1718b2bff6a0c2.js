...
formEvents.directive("rbxFormContext", function () {
  return {
    ...
    link: function (scope, elem, attrs, ctrl) {
      var name = ctrl.$name;
      ctrl.context =
        attrs["context"] + name.charAt(0).toUpperCase() + name.substr(1);
    },
  };
...
robloxApp.factory("phoneService", [
  ...
  "httpService",
  "phoneConstants",
  function ($q, httpService, phoneConstants) {
    ...
    function addPhone(phoneInfo) {
      var url =
        Roblox.EnvironmentUrls.accountInformationApi +
        phoneConstants.urls.addPhoneV2;
      var urlConfig = { url: url };
      var params = {
    ...
    function verifyPhone(codeInfo) {
      var url =
        Roblox.EnvironmentUrls.accountInformationApi +
        phoneConstants.urls.verifyPhoneV2;
      var urlConfig = { url: url };
    ...
    function resendCode() {
      var url =
        Roblox.EnvironmentUrls.accountInformationApi +
        phoneConstants.urls.resendCodeV2;
      var urlConfig = { url: url };
