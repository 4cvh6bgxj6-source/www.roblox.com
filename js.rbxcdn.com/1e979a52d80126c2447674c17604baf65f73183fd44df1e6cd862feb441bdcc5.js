!(function () {
  ...
  var o,
    ...
    g = {
      urls: {
        getMetadata: "".concat(
          p.EnvironmentUrls.apiGatewayCdnUrl,
          "/captcha/v1/metadata"
        ),
        funCaptchaRedeem: {
          WebSignup: "".concat(
  ...
  function E(e) {
    ...
    s &&
      ...
      window.EventTracker && window.EventTracker.fireEvent(m(d + t)),
      (s = null)),
      w(d, e, n);
  }
  function S(e, t, n) {
  ...
  function w(e, t, n) {
    ...
    c().ajax({
      ...
      success: function () {
        window.EventTracker &&
          window.EventTracker.fireEvent(m(e + h.successSuffix)),
          S(e, n, !0),
          u && (u(), c()("#" + o).empty());
      },
      error: function () {
        window.EventTracker &&
          window.EventTracker.fireEvent(m(e + h.failSuffix)),
          S(e, n, !1),
          l && l(),
          p.BootstrapWidgets &&
    ...
    (h = g.serviceData),
    {
      ...
      reset: function (e, t, n, a) {
        (d = e),
          ...
          window.grecaptcha &&
            ...
            v.invisible && window.grecaptcha.execute(r));
      },
      render: function (e, t, n, a, i) {
        (d = t),
          ...
          (o = e),
          window.grecaptcha &&
            ((i = { sitekey: h.sitekey, callback: E, badge: h.badgePosition }),
            v.invisible && (i.size = "invisible"),
            (r = window.grecaptcha.render(e, i)),
            window.EventTracker &&
              window.EventTracker.fireEvent(m(d + h.displayedSuffix)),
            (s = T()));
      },
      execute: function () {
  ...
  var y = (function () {
    ...
    e =
      null !== (e = p.EnvironmentUrls.apiGatewayUrl) && void 0 !== e
        ? e
        : "URL_NOT_FOUND",
      ...
      (this.provider = e),
        ...
        (this.startStatisticsSequence = function (e) {
          this.eventTimer.start(e),
            window.EventTracker && window.EventTracker.start(n(e));
        }),
        ...
        (this.logTriggered = function (e) {
          this.fireEvent(e, r.triggeredSuffix),
            this.startStatisticsSequence(
              a(e + this.provider + r.completedTimeSequenceSuffix)
            );
        }),
    ...
    e = (function () {
      ...
      return {
        ...
        showFunCaptchaInModal: function () {
          ...
          var e = c()("#game-card-redeem-captcha")
            .removeClass("hidden")
            .detach();
  ...
  (window.Roblox.Captcha = t),
    ...
    (window.Roblox.CaptchaConstants = g);
})();
